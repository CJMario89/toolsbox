<script>
    ...
    document.getElementById("1000to").classList.add("borderTBHover");
    document.getElementById("1000to").closest(".borderLR").classList.add("borderLRHover");
    document.querySelectorAll(".selectedOption")[0].innerHTML = document.getElementById("1fr").innerHTML;
    document.querySelectorAll(".selectedOption")[1].innerHTML = document.getElementById("1000to").innerHTML;
